...
$cmds = array(
    ...
    'pywho_view'      => array("docker_exec", "glftpd", '["sh", "-c", "busybox killall -9 gotty; gotty /glftpd/bin/pywho >/dev/null 2>&1 &"]'),
    'pyspy_view'      => array("docker_exec", "glftpd", '["sh", "-c", "busybox killall -9 gotty; gotty /glftpd/bin/spy >/dev/null 2>&1 &"]'),
